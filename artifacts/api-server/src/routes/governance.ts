...
const ROUTE_REGISTRY: RouteEntry[] = [
  ...
  { method: "*",    path: "/api/omnistrike",         exposure: "command_center",tier: "labs",       auth: true,  rateLimit: "10/min",    tags: ["redteam","labs"],     owner: "labs",      reason: "multi-vector attack orchestration",    risk: "critical", approvalRequired: true,  tenantAware: false },
  { method: "*",    path: "/api/redteam-scan",       exposure: "command_center",tier: "labs",       auth: true,  rateLimit: "10/min",    tags: ["redteam","labs"],     owner: "labs",      reason: "red team scanning",                    risk: "critical", approvalRequired: true,  tenantAware: false },
  ...
  { method: "*",    path: "/api/sqli-scanner",       exposure: "command_center",tier: "labs",       auth: true,  rateLimit: "10/min",    tags: ["injection","labs"],   owner: "labs",      reason: "SQL injection scanner",                risk: "critical", approvalRequired: true,  tenantAware: false },
  { method: "*",    path: "/api/waf-bypass",         exposure: "command_center",tier: "labs",       auth: true,  rateLimit: "10/min",    tags: ["waf","labs"],         owner: "labs",      reason: "WAF bypass testing",                   risk: "critical", approvalRequired: true,  tenantAware: false },
  { method: "*",    path: "/api/sqlmap",             exposure: "command_center",tier: "labs",       auth: true,  rateLimit: "5/min",     tags: ["injection","labs"],   owner: "labs",      reason: "SQLMap automated injection scanner",   risk: "critical", approvalRequired: true,  tenantAware: false },
  { method: "*",    path: "/api/exploit-import",     exposure: "command_center",tier: "labs",       auth: true,  rateLimit: "5/min",     tags: ["exploit","labs"],     owner: "labs",      reason: "exploit database import",              risk: "critical", approvalRequired: true,  tenantAware: false },
  { method: "*",    path: "/api/intruder",           exposure: "command_center",tier: "labs",       auth: true,  rateLimit: "10/min",    tags: ["fuzzing","labs"],     owner: "labs",      reason: "HTTP intruder / fuzzer",               risk: "critical", approvalRequired: true,  tenantAware: false },
  { method: "*",    path: "/api/oast",               exposure: "command_center",tier: "labs",       auth: true,  rateLimit: "10/min",    tags: ["oob","labs"],         owner: "labs",      reason: "OOB application security testing",     risk: "critical", approvalRequired: true,  tenantAware: false },
  { method: "*",    path: "/api/node-cracker",       exposure: "command_center",tier: "labs",       auth: true,  rateLimit: "5/min",     tags: ["blockchain","labs"],  owner: "labs",      reason: "blockchain node vulnerability cracker",risk: "critical", approvalRequired: true,  tenantAware: false },
