...
import {
  ...
  listThreatModelGenerator,
} from "../services/threatModelGeneratorService";
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const result = await createThreatModelGenerator({
      ...body,
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    res.json({ items: await listThreatModelGenerator(query) });
  }),
);
