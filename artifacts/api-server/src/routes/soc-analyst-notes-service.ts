...
import {
  createSocAnalystNotes,
  listSocAnalystNotes,
} from "../services/socAnalystNotesServiceService";
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const result = await createSocAnalystNotes({
      ...body,
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    res.json({ items: await listSocAnalystNotes(query) });
  }),
);
