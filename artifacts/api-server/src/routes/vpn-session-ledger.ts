...
import {
  createVpnSessionLedger,
  listVpnSessionLedger,
} from "../services/vpnSessionLedgerService";
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const result = await createVpnSessionLedger({
      ...body,
...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    res.json({ items: await listVpnSessionLedger(query) });
  }),
);
