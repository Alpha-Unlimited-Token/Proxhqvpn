    ...
    return (
      <Layout>
        <div className="text-center py-20">
          ...
          <Button className="mt-6" onClick={() => setLocation("/hosts")}>Back to Hosts</Button>
        </div>
      </Layout>
    );
  }
                ...
                {loadingEvents ? (
                  ...
                  <div className="space-y-3">
                    ...
                    {events && events.length >= 10 && (
                      <Button variant="link" className="w-full mt-2" onClick={() => setLocation(`/events?hostId=${hostId}`)}>
