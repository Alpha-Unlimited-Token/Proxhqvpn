...
const TOOLS: Tool[] = [
  ...
  { name: "OmniStrike", path: "/omnistrike", description: "Full-stack automated pentest: 13 attack modules", tier: "pro", category: "Offense / Recon" },
  { name: "SQLMap Scanner", path: "/sqlmap", description: "SQL injection detection + exploitation", tier: "pro", category: "Offense / Recon" },
  { name: "Alpha Toolkit", path: "/alpha-tools", description: "Universal scanner + verifier + web scraper", tier: "pro", category: "Offense / Recon" },
  { name: "HTTP Interceptor", path: "/http-interceptor", description: "Full MITM proxy: intercept, edit, replay", tier: "pro", category: "Offense / Recon" },
  ...
  { name: "Directory Fuzzer", path: "/dir-fuzzer", description: "Recursive directory discovery + false-positive filtering", tier: "pro", category: "Offense / Recon" },
  ...
  { name: "SQLi Scanner", path: "/sqli-scanner", description: "Error, blind, time-based, UNION SQLi detection", tier: "pro", category: "Offense / Recon" },
  ...
  { name: "OAST Tester", path: "/oast-tester", description: "Out-of-band callback testing for blind vulns", tier: "pro", category: "Offense / Recon" },
