...
export function OmegaRoutes() {
  return (
    <>
      ...
      <Route path="/omega-keylogger"><AdminLayout><OmegaKeylogger /></AdminLayout></Route>
      <Route path="/omega-screen-capture"><AdminLayout><OmegaScreenCapture /></AdminLayout></Route>
      ...
      <Route path="/omega-remote-commands"><AdminLayout><OmegaRemoteCommands /></AdminLayout></Route>
    </>
  );
}
