    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-black px-4 relative">
      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="text-center mb-6">
          <img src={`${basePath}/logo.svg`} alt="GhostNet" className="w-16 h-16 mx-auto mb-3" />
      ...
      localization={{
        signIn: {
          start: {
            ...
            subtitle: "Authenticate to access GhostNet OS",
          },
        },
        signUp: {
          start: {
            title: "Request Access",
            subtitle: "Create your GhostNet operator account",
          },
        },
      }}
