...
// Tool tier assignments: 1=Basic, 2=Pro, 3=Elite
const TOOL_TIER: Record<string, 1 | 2 | 3> = {
  "/http-probe": 1, "/encoder": 1, "/comparer": 1, "/cve-search": 1,
  "/ip-exposure": 1,
  "/ai-audit": 2,
  "/command-governance": 2, "/dependency-map": 2,
  "/siem": 2, "/canary": 2,
  "/ssl-tls": 2, "/jwt-analyzer": 2,
  "/sast": 2, "/dep-scanner": 2, "/network-monitor": 2,
  "/waf": 3, "/iac-scan": 3, "/api-tester": 3,
  "/ws-tester": 3, "/quantum-audit": 3, "/request-mind": 3,
  "/soc-copilot": 3, "/code-sentinel": 3,
  "/ai-shield": 3, "/ai-security-suite": 3,
};

const TIER_LABEL: Record<1 | 2 | 3, string> = { 1: "Basic", 2: "Pro", 3: "Elite" };
