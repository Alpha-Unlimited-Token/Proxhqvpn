...
const MODE_LABELS: Record<string, { label: string; description: string; badge: string }> = {
  fwmark:        { label: "fwmark Routing",    description: "Packet marking routes GhostNet traffic through its own table. Native VPN handles everything else. Zero conflicts.", badge: "RECOMMENDED" },
  "double-hop":  { label: "Double-Hop",        description: "Traffic flows Device → GhostNet → Native VPN → Internet. Maximum anonymity. Neither provider sees plaintext traffic.", badge: "MAX PRIVACY" },
  namespace:     { label: "Namespace Isolation",description: "GhostNet runs in its own Linux network namespace. Completely isolated — no routing conflicts possible.", badge: "ADVANCED" },
...
export default function VpnCoexist() {
  ...
  const [ghostnetIface, setGhostnetIface] = useState("ghostnet0");
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-primary/50 mt-0.5">
                Run GhostNet alongside NordVPN, ExpressVPN, ProtonVPN, Mullvad, and others
              </p>
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="border border-primary/20 p-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div>
                <label className="text-[9px] text-primary/40 block mb-1">GHOSTNET INTERFACE</label>
                <input
                  value={ghostnetIface}
                  onChange={e => setGhostnetIface(e.target.value)}
                  className="w-full bg-black border border-primary/30 text-primary text-xs px-2 py-1.5 font-mono focus:outline-none focus:border-primary"
                  placeholder="ghostnet0"
                />
              </div>
              <div>
          ...
          <div className="border border-primary/20 p-4">
            ...
            <div className="space-y-3 text-[11px] text-primary/60 leading-relaxed">
              <p>
                ...
                GhostNet avoids this with <span className="text-primary">policy-based routing</span>.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="border border-primary/10 p-3">
                  ...
                  <p className="text-[10px] text-primary/50">
                    Each packet that should go through GhostNet is marked with an fwmark value.
                ...
                <div className="border border-primary/10 p-3">
                  ...
                  <p className="text-[10px] text-primary/50">
                    GhostNet tunnel is established first. Its packets exit through the native
                    VPN as outer tunnel. Your ISP sees only native VPN traffic. The native VPN
                    provider sees only encrypted GhostNet packets. Neither sees your data.
                  </p>
                </div>
                <div className="border border-primary/10 p-3">
                  <div className="text-primary text-[10px] font-bold mb-1">NAMESPACE METHOD (Linux)</div>
                  <p className="text-[10px] text-primary/50">
                    GhostNet runs in a dedicated Linux network namespace — a completely
                ...
                <div className="border border-primary/10 p-3">
                  ...
                  <p className="text-[10px] text-primary/50">
                    Interface metrics and static routes direct specific traffic (GhostNet
                    mesh CIDRs) through GhostNet's interface, while the native VPN retains
        ...
        <div className="space-y-4">
          <div className="border border-primary/20 p-4">
            ...
            <p className="text-[11px] text-primary/50 mb-4">
              Exception rules define which IP ranges bypass GhostNet, are forced through GhostNet,
            ...
            <div className="border border-primary/20 p-3 mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
                ...
                <select
                  ...
                  className="bg-black border border-primary/30 text-primary text-xs px-2 py-1.5 font-mono focus:outline-none focus:border-primary"
                >
                  <option value="bypass-ghostnet">Bypass GhostNet → Native VPN</option>
                  <option value="force-ghostnet">Force through GhostNet</option>
          ...
          <div className="border border-primary/20 p-4">
            ...
            <p className="text-[11px] text-primary/50 mb-3">
              ...
              GhostNet from intercepting traffic to those VPN endpoints.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          ...
          <div className="border border-primary/20 p-4">
            ...
            <div className="border border-primary/20">
              ...
              {[
                ...
                ["GhostNet + Native VPN", "1500", "1380", "Double-hop: 2× overhead"],
                ["GhostNet + Tor hidden svc", "1500", "1280", "Tor cells are 512B, limits MTU"],
              ...
              <div className="border border-primary/20 p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={() => downloadScript(generatedScript, "ghostnet-coexist-enable")}
              ...
              <div className="border border-red-400/20 p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button onClick={() => downloadScript(disableScript, "ghostnet-coexist-disable")}
                ...
                <p className="text-[10px] text-red-400/50 mt-2">
                  Keep this script safe. Run it to cleanly remove all GhostNet coexistence rules and restore your system to its original routing configuration.
                </p>
              </div>
            </>
          )}
