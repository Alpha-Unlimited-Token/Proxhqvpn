    ...
    items: [
      {
        ...
        steps: [
          { text: "Download the ProxhqVPN Setup .zip above and extract it — you will find 'Launch-ProxhqVPN-Setup.vbs' and 'Install.ps1'." },
          { text: "Double-click 'Launch-ProxhqVPN-Setup.vbs' to open the setup wizard (the VBS wrapper hides the console window for a clean experience)." },
          { text: "If Windows shows a SmartScreen warning — click 'More info' then 'Run anyway'. This is normal for any installer downloaded outside the Microsoft Store." },
          { text: "Step 1 — Welcome screen: review the features and click 'Get Started'." },
          { text: "Step 2 — License & VPN Mode: accept the agreement, then choose your tunnel mode. Split Tunnel (recommended) lets all your apps work normally while VPN traffic is tunneled. Full Tunnel routes everything through ProxhqVPN for maximum privacy." },
          { text: "Step 3 — Auto-install: the wizard silently downloads WireGuard from wireguard.com and installs it with no prompts. A progress bar tracks each phase: ① WireGuard → ② Detect Config → ③ Activate Tunnel." },
          { text: "Step 4 — Auto-activate: the wizard opens ProxhqVPN in your browser. Sign in, go to WireGuard Config → Generate Config → Download. The wizard watches your Downloads folder and the moment the .conf file lands, it applies your tunnel mode setting and runs wireguard.exe /installtunnel automatically — the VPN activates with no further clicks." },
          { text: "Step 5 — Done screen shows the status of WireGuard, your tunnel mode, and desktop shortcut. Click 'Open ProxhqVPN' to launch the dashboard." },
        ],
        note: "WireGuard is installed silently from the official wireguard.com release. The installer registers ProxhqVPN in Windows Add/Remove Programs. No manual WireGuard download required.",
      },
      {
