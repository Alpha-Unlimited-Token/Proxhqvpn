  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        ...
        <Note type="info">QuantumAudit is for authorized security research on smart contracts and addresses you own or have explicit permission to audit. All scan sessions are logged in the audit trail.</Note>
      </div>
    ),
  },
  {
