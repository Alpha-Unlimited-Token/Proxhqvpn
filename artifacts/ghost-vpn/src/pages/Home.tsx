...
const PRICING_PLANS = [
  {
    ...
    period: "/month",
    annual: "$89.99/yr",
    annualNote: "~$7.50/mo · save 25% annual",
    desc: "Privacy + protection for everyday users, families, and gamers.",
    highlight: false,
    badge: null,
    features: [
      ...
      "Stealth obfuscation — bypass DPI",
      "Unlimited simultaneous devices",
      "Basic firewall rules & IP blocklist",
      "No logs policy",
  ...
  },
  {
    ...
    period: "/month",
    annual: "$399/yr",
    annualNote: "~$33.25/mo · save 17% annual",
    desc: "Full security research toolkit for developers, consultants & pentesters.",
    highlight: true,
    badge: "BEST VALUE",
    features: [
      ...
      "SilkWeb honeypot + Beacon intrusion alerts",
      "Security Audit (TLS / headers / WHOIS)",
      "SHA3-256 audit chain history",
      "Device manager & WireGuard device registry",
      "Compare: Burp Suite Pro $475/yr (scanner only)",
    ],
  },
  {
    name: "Business",
    price: "$12–15",
    period: "/user/month",
    annual: "10-user minimum",
    annualNote: "~$150/mo to start",
    desc: "Team management, RBAC, compliance & centralized security for SMBs and MSPs.",
    highlight: false,
    badge: null,
    features: [
      "Everything in Professional",
      "RBAC — 6 roles for your team",
      "User management & device inventory",
      "Compliance reporting & export",
      "VPN policy enforcement per user",
      "SIEM unified event log",
      "Centralized SHA3-256 audit ledger",
      "Node analytics across your fleet",
  ...
  },
  {
    ...
    period: "",
    annual: "$500–$5,000+/mo",
    annualNote: "Based on users & nodes",
    desc: "Zero Trust + Command Center + Deception Platform for security teams and corporations.",
    highlight: false,
    badge: "ENTERPRISE",
    features: [
      "Everything in Business",
      "Zero Trust / ZTNA device posture",
      "Ghost Nodes — ephemeral exit VPS",
      "Command Center (full offensive toolkit)",
      "Deception platform (Ghost Trap + Honeypot)",
      "QuantumAudit blockchain scanner",
      "SSO / SAML + dedicated account manager",
      "Custom SLA + 24/7 priority support",
      "Custom node deployment & management",
    ],
  },
];
      ...
      <section id="pricing" className="py-24 px-6 border-t border-white/[0.05]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold tracking-tight mb-4">Four products. One platform.</h2>
            <p className="text-white/78 text-lg">Personal privacy to Enterprise Zero Trust — every tier built on the same WireGuard infrastructure.</p>
          </div>
