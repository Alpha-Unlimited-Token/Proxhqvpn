#!/usr/bin/env bash
# ══════════════════════════════════════════════════════════════════════════════
#  GhostNet VPN — Easy Setup (run this if you downloaded the zip manually)
#
#  HOW TO USE:
#    1. Extract the zip file
#    2. Open Terminal in the extracted folder
#    3. Run:  bash ghostnet-setup.sh
#
#  That's it. GhostNet will start and open in your browser automatically.
# ══════════════════════════════════════════════════════════════════════════════
...
echo ""
echo -e "${GRN}${BLD}  ╔══════════════════════════════════════════════╗${NC}"
echo -e "${GRN}${BLD}  ║       GHOSTNET VPN — EASY SETUP             ║${NC}"
echo -e "${GRN}${BLD}  ╚══════════════════════════════════════════════╝${NC}"
echo ""
...
chmod +x "$DIR/GhostNet"  2>/dev/null && ok "GhostNet executable ready" || true
...
echo ""
echo -e "  ${BLD}GhostNet is ready to start.${NC}"
echo ""
echo "  Dashboard:  http://localhost:$PORT"
echo "  Location:   $DIR"
echo ""
echo -e "  ${YLW}Press Ctrl+C at any time to stop GhostNet.${NC}"
echo ""
...
# ── Launch ────────────────────────────────────────────────────────────────────
echo ""
echo -e "${GRN}  ● GhostNet running at http://localhost:${PORT}${NC}"
echo ""
PORT="$PORT" "$DIR/GhostNet"
