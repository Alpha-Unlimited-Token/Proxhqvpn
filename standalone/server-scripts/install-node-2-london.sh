...
# Server : proxhqvpn-node-2
# Region : EU-London
# IP     : 192.248.160.69
# Generated: 2026-06-18 23:04 UTC
set -e
echo "=================================================="
echo " ProxhqVPN Installer — proxhqvpn-node-2 (EU-London)"
echo "=================================================="

# ── Pre-filled variables (no editing needed) ──────────────────────────────────
export NODE_ID="proxhqvpn-node-2"
export NODE_REGION="EU-London"
...
NODE_ID=proxhqvpn-node-2
NODE_REGION=EU-London
...
table inet nat {
  chain postrouting {
    ...
    ip saddr 10.8.1.0/24 masquerade
  }
}
NFTEOF
...
echo ""
echo "══════════════════════════════════════════════════"
echo " proxhqvpn-node-2 — Install Complete"
echo "══════════════════════════════════════════════════"
echo ""
...
echo ""
echo "══════════════════════════════════════════════════"
echo " Done. All 15 steps complete on proxhqvpn-node-2."
echo "══════════════════════════════════════════════════"
