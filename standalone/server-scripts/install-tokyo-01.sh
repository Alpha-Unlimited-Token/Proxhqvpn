...
# Server : proxhqvpn-tokyo-01
# Region : AP-Tokyo
# IP     : 45.76.97.51
# Generated: 2026-06-18 23:04 UTC
set -e
echo "=================================================="
echo " ProxhqVPN Installer — proxhqvpn-tokyo-01 (AP-Tokyo)"
echo "=================================================="

# ── Pre-filled variables (no editing needed) ──────────────────────────────────
export NODE_ID="proxhqvpn-tokyo-01"
export NODE_REGION="AP-Tokyo"
...
table inet nat {
  chain postrouting {
    ...
    ip saddr 10.8.2.0/24 masquerade
  }
}
NFTEOF
...
echo ""
echo "══════════════════════════════════════════════════"
echo " proxhqvpn-tokyo-01 — Install Complete"
echo "══════════════════════════════════════════════════"
echo ""
...
echo ""
echo "══════════════════════════════════════════════════"
echo " Done. All 15 steps complete on proxhqvpn-tokyo-01."
echo "══════════════════════════════════════════════════"
